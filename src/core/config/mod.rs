...
fn default_db_cache_capacity_mb() -> f64 { 256.0 + (64.0 * (crate::utils::available_parallelism() as f64)) }

fn default_pdu_cache_capacity() -> u32 { 150_000 + (10_000 * crate::utils::available_parallelism() as u32) }

fn default_conduit_cache_capacity_modifier() -> f64 { 1.0 }

fn default_auth_chain_cache_capacity() -> u32 { 150_000 + (10_000 * crate::utils::available_parallelism() as u32) }

fn default_shorteventid_cache_capacity() -> u32 { 400_000 + (50_000 * crate::utils::available_parallelism() as u32) }
