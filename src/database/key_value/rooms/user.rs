...
impl service::rooms::user::Data for KeyValueDatabase {
	fn update_notification_counts(
		...
		self.userroomid_notificationcount.insert(&userroom_id, &notification_count.to_be_bytes())?;
		self.userroomid_highlightcount.insert(&userroom_id, &highlight_count.to_be_bytes())?;
